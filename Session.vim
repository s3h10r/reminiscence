...
637
normal! zo
let s:l = 64 - ((15 * winheight(0) + 16) / 33)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 27 - ((25 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
wincmd w
argglobal
if bufexists("docker-compose.development.yml") | buffer docker-compose.development.yml | else | edit docker-compose.development.yml | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
39
normal! zo
let s:l = 49 - ((14 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
wincmd w
argglobal
if bufexists("docker-test-vostok_flavour.sh") | buffer docker-test-vostok_flavour.sh | else | edit docker-test-vostok_flavour.sh | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
tabnext 3
badd +0 ./pages/admin.py
badd +0 ./pages/apps.py
badd +0 ./pages/custom_read.py
badd +0 ./pages/dbaccess.py
badd +0 ./pages/forms.py
badd +0 ./pages/__init__.py
badd +1 ./pages/models.py
badd +0 ./pages/summarize.py
badd +0 ./pages/urls.py
badd +0 ./pages/utils.py
badd +1 ./pages/views.py
badd +1 ./templates/includes/latest_entries.html
badd +27 Dockerfile.armv7l.vostok
badd +43 templates/home.html
badd +38 docker-compose.development.yml
badd +3 docker-test-vostok_flavour.sh
